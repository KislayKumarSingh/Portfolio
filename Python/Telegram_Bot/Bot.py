...
async def help(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    if update.effective_user.id == 5625198558:
    ...
    try:
        ...
        if val_status:
            ...
            try:
                ...
                bfd.main(start_date + ' 00:00:00', end_date + ' 23:59:59', last_modified_date, 'Automatic',
                         str(date.today() - timedelta(days=1)), str(date.today()), scope)
...
def main() -> None:
    application = Application.builder().token(sc.decrypt('t_api')).build()
